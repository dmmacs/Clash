...
def buildhtmlHeader (title):
    ...
    retVal += '<meta http-equiv="refresh" content="300">'
    retVal += '<link rel="icon" type="image/png" href="../img/favicon-16x16.16d92b.png" sizes=16x16>\n'
    retVal += '<link rel="icon" type="image/png" href="../img/favicon-16x16.16d92b.png" sizes=16x16>\n'
    retVal += '<link rel="icon" type="image/png" href="../img/favicon-32x32.09ad6d.png" sizes=32x32>\n'
    retVal += '<link rel="icon" type="image/png" href="../img/favicon-96x96.0fce98.png" sizes=96x96>\n'
    retVal += '<link rel="icon" type="image/png" href="../img.com/favicon-192x192.6f82ec.png" sizes=192x192>\n'
    retVal += '<link rel="shortcut icon" href=../img/favicon.673a60.ico>\n'
